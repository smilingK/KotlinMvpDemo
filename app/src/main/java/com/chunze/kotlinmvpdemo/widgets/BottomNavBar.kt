package com.chunze.kotlinmvpdemo.widgets
...
class BottomNavBar @JvmOverloads constructor(
    ...
    init {
        ...
        //购物车
        val cartItem = BottomNavigationItem(R.drawable.btn_nav_cart_press, resources.getString(R.string.nav_bar_shopping_cart))
        ...
        //消息
        val msgItem = BottomNavigationItem(R.drawable.btn_nav_msg_press, resources.getString(R.string.nav_bar_notifications))
        ...
        //我的
        val userItem = BottomNavigationItem(R.drawable.btn_nav_user_press, resources.getString(R.string.nav_bar_my))
